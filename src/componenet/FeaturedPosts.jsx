  ...
  return (
    <div className="mt-8 flex flex-col lg:flex-row gap-8">
      ...
      <div className="w-full lg:w-1/2 flex flex-col gap-4">
        ...
        <Link
          to={posts[0].slug}
          className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold lg:font-bold"
        >
          {posts[0].title}
        </Link>
      </div>
        ...
        {posts[1] && (
          <div className="lg:h-1/3 flex justify-between gap-4">
            ...
            <div className="w-2/3">
              ...
              <Link
                to={posts[1].slug}
                className="text-sm sm:text-base md:text-lg lg:text-xl font-medium line-clamp-2"
              >
                {posts[1].title}
              </Link>
            </div>
